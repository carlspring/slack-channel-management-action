#!/usr/bin/env python3
"""
Posts a comment on the GitHub issue confirming the Slack channel was unarchived.
...
def main() -> None:
    ...
    if channel_url:
        body = f"Slack channel unarchived: [#{channel_name}]({channel_url})"
    else:
        body = f"Slack channel unarchived: #{channel_name}"
    ...
    print(f"Posted comment confirming unarchive of #{channel_name}")
